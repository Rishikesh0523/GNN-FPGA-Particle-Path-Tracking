`timescale 1ns / 1ps
//==============================================================================
// MP_Edge_Layer_B7_L2.v  --  Auto-generated by gen_layers.py
//
// Block 7, Layer 2
    ...
    generate
        ...
        if (NUM_NEURONS > 0) begin : neuron_0
            neuron #(
                ...
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_0.mif"),
                .BiasFile    ("mp_edge_b_7_2_0.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
        ...
        if (NUM_NEURONS > 1) begin : neuron_1
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_1.mif"),
                .BiasFile    ("mp_edge_b_7_2_1.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 2) begin : neuron_2
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_2.mif"),
                .BiasFile    ("mp_edge_b_7_2_2.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 3) begin : neuron_3
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_3.mif"),
                .BiasFile    ("mp_edge_b_7_2_3.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 4) begin : neuron_4
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_4.mif"),
                .BiasFile    ("mp_edge_b_7_2_4.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 5) begin : neuron_5
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_5.mif"),
                .BiasFile    ("mp_edge_b_7_2_5.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 6) begin : neuron_6
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_6.mif"),
                .BiasFile    ("mp_edge_b_7_2_6.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 7) begin : neuron_7
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_7.mif"),
                .BiasFile    ("mp_edge_b_7_2_7.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 8) begin : neuron_8
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_8.mif"),
                .BiasFile    ("mp_edge_b_7_2_8.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 9) begin : neuron_9
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_9.mif"),
                .BiasFile    ("mp_edge_b_7_2_9.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 10) begin : neuron_10
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_10.mif"),
                .BiasFile    ("mp_edge_b_7_2_10.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 11) begin : neuron_11
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_11.mif"),
                .BiasFile    ("mp_edge_b_7_2_11.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 12) begin : neuron_12
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_12.mif"),
                .BiasFile    ("mp_edge_b_7_2_12.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 13) begin : neuron_13
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_13.mif"),
                .BiasFile    ("mp_edge_b_7_2_13.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 14) begin : neuron_14
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_14.mif"),
                .BiasFile    ("mp_edge_b_7_2_14.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 15) begin : neuron_15
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_15.mif"),
                .BiasFile    ("mp_edge_b_7_2_15.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 16) begin : neuron_16
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_16.mif"),
                .BiasFile    ("mp_edge_b_7_2_16.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 17) begin : neuron_17
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_17.mif"),
                .BiasFile    ("mp_edge_b_7_2_17.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 18) begin : neuron_18
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_18.mif"),
                .BiasFile    ("mp_edge_b_7_2_18.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 19) begin : neuron_19
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_19.mif"),
                .BiasFile    ("mp_edge_b_7_2_19.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 20) begin : neuron_20
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_20.mif"),
                .BiasFile    ("mp_edge_b_7_2_20.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 21) begin : neuron_21
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_21.mif"),
                .BiasFile    ("mp_edge_b_7_2_21.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 22) begin : neuron_22
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_22.mif"),
                .BiasFile    ("mp_edge_b_7_2_22.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 23) begin : neuron_23
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_23.mif"),
                .BiasFile    ("mp_edge_b_7_2_23.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 24) begin : neuron_24
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_24.mif"),
                .BiasFile    ("mp_edge_b_7_2_24.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 25) begin : neuron_25
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_25.mif"),
                .BiasFile    ("mp_edge_b_7_2_25.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 26) begin : neuron_26
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_26.mif"),
                .BiasFile    ("mp_edge_b_7_2_26.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 27) begin : neuron_27
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_27.mif"),
                .BiasFile    ("mp_edge_b_7_2_27.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 28) begin : neuron_28
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_28.mif"),
                .BiasFile    ("mp_edge_b_7_2_28.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 29) begin : neuron_29
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_29.mif"),
                .BiasFile    ("mp_edge_b_7_2_29.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 30) begin : neuron_30
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_30.mif"),
                .BiasFile    ("mp_edge_b_7_2_30.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
        ...
        if (NUM_NEURONS > 31) begin : neuron_31
            neuron #(
                ...
                .WEIGHT_BITS (WEIGHT_BITS),
                .BIAS_BITS   (BIAS_BITS),
                .WeightFile  ("mp_edge_w_7_2_31.mif"),
                .BiasFile    ("mp_edge_b_7_2_31.mif")
            ) inst (
                .clk                (clk),
                .rstn               (rstn),
                .activation_function(activation_function),
